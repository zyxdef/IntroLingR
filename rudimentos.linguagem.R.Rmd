...
1. Programação em R
    ...
    1. [Operadores de Indexação](#160)
    1. [Operações e Funções Matemáticas](#247)
    1. [Operações e Funções de Comparação](#263)
    1. [Operações e Funções Lógicas](#267)
    1. [Instruções de Repetições](#274)
    1. [Instruções de Execução Condicional](#299)
